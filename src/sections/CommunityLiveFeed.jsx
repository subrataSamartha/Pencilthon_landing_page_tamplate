...
function CommunityLiveFeed() {
  return (
    <div className="max-w-[1280px] p-8 md:p-24 mx-auto flex flex-col md:flex-row bg-mySecondary items-center">
      <div className="w-full md:w-[50%]">
        <h1 className="text-white text-4xl font-bold">Community Live Feed</h1>
      </div>
